...
{
    public class dbf_DBConn : IDisposable
    {
        #region "Declarations"
        private string zFilename = "DatabaseConnections.dll version 1.0.0.0";
        private string zClass = "AccessDBConnection";
        ...
        public dbf_DBConn(string Database)
        {
        ...
        {
            strConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + strDatabase + ";Extended Properties=DBASE IV;";
        }
